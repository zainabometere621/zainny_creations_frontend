  ...
  return (
    <div className="bg-linear-to-r from-[#fdf4f2] to-[#faece8] pb-1 shadow-sm">
      <div className="flex flex-col justify-center items-center">
        <h1 className="font-playfair font-black text-2xl mt-8 text-center">
          Trending Now
        </h1>
        <p className="font-poppins text-sm text-gray-500 mt-4 text-center">
          Our season’s signature style pieces
        </p>
      </div>
      ...
      <div className="bg-linear-to-r from-[#e9a8ad] via-[#f3c3c2] to-[#f7e7c6] rounded-3xl p-10 w-4/5 h-50 mx-auto m-30 flex flex-col gap-4 justify-center">
        <h2 className="font-popins text-base text-white font-semibold">
          Want Something Unique?
        </h2>
        <p className="font-playfair text-xs text-white">
          Book a consultation with our designers and bring your dream outfit to
          life.
        </p>
